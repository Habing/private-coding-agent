...
| **#12** | `go test ./internal/memory/... -count=1`；E2E 步 69 `POST /admin/memories/re-embed`（全量脚本 **75/75**） |
...
cd deploy/compose && ./test-e2e.sh    # 期望 75/75
```
...
| 2026-05-23 | #12/#13 | re-embed admin + snapshot restore；E2E 75/75 |
| 2026-05-23 | 19b NL | workflow proposals + E2E 70–75 |
